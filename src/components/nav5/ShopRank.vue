<template>
  <div id="ShopRank">
    ...
    <el-dialog title="编辑" :visible.sync="dialogVisible1" width="90%" top="10vh">
      ...
      <dl class="text">
        <dd class="item1">商家等级:</dd>
        <dd class="item">
          <el-input v-model="c_level" clearable></el-input>
        </dd>
        <dd style="font-size: 11px; text-align: left; color:red;">设置等级编号,编号越大级别越高</dd>
        <dd style="font-size: 12px; text-align: left; color:red;">设置0则为非会员商家</dd>
      </dl>
      <dl class="text">
    ...
    <!-- 添加弹窗 -->
    <el-dialog title="添加" :visible.sync="dialogVisible3" width="90%" top="10vh">
      <dl class="text">
        <dd class="item1">名称:</dd>
        <dd class="item">
      ...
      <dl class="text">
        <dd class="item1">商家等级:</dd>
        <dd class="item">
          <el-input v-model="level" clearable></el-input>
        </dd>
        <dd style="font-size: 11px; text-align: left;">设置等级编号,编号越大级别越高</dd>
        <dd style="font-size: 12px; text-align: left;">设置0则为非会员商家</dd>
      </dl>
      <dl class="text">
        <dd class="item1">有效天数:</dd>
        <dd class="item">
...
export default {
  ...
  methods:{
    ...
    change(row){
      ...
      this.c_name = row.levelName;
      this.c_level = row.levelGrade
    ...
    changeData(){
      ...
      let obj = {
        ...
        levelName:this.c_name,
        levelGrade:this.c_level,
        timeBar:this.c_time,
        pkId:this.c_id,
        fkCcoicId:fkId,
        OpenId:OpenId
      };
      let changeShopRank = axios.changeShopRank(obj);
      changeShopRank.then((res) => {
        if(res.data.msg == 'OK'){
    ...
    delData(){
      ...
      let delShopRank = axios.delShopRank(obj);
      delShopRank.then((res) => {
        if(res.data.msg == 'OK'){
    ...
    addData(){
      ...
      let obj = {
        expense:this.pirce,
        levelName:this.name,
        levelGrade:this.level,
        timeBar:this.time,
        fkCcoicId:fkId,
        OpenId:OpenId
      };
      let addShopRank = axios.addShopRank(obj);
      addShopRank.then((res) => {
        if(res.data.msg == 'OK'){
